      ...
      <div className="container">
        ...
        <div className='max-w-xl mx-auto'>
          <p className="text-center mt-5 text-xl text-white/70">
            Discover the ideal mental health companion for your needs—whether for personal wellness, therapy support, or daily monitoring, we have plans to maximize your emotional well-being and quality of life.  </p>
        </div>
